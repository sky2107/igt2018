...
public class NestedTransactionForTest {
    ...
    public static void main(String[] args) {
		...
		MyCustomer c1 = MyCustomerController.getControllerInstance().createCustomer("Adress1", "John Doe", handys1);
		MyCustomer c2 = MyCustomerController.getControllerInstance().createCustomer("Adress2", "Dohn Joe", handys2);
